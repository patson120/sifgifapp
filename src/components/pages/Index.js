...
export const Index = () => {
    return (
        <div className="Index">
            <div className="container-fluid rounded-pill" style={{ padding: '10px', background: 'green' }}>
                <div className="rounded-pill" style={{ padding: '10px', background: 'red' }}>
                    <div className="rounded-pill" style={{ padding: '10px', background: 'yellow' }}>
